...
import org.apache.hadop.examples.render.TestBase;
import org.junit.Test;

@Slf4j
public class TestBasicTwillJob extends TestBase implements Arguments {


  @Test
  public void testCli() throws Throwable {
    RenderTwillMain renderer = new RenderTwillMain();
    renderer.exec(ARG_ZK, microZKCluster.getZkBindingString());
  }
}
